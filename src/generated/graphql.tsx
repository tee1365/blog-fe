...
export type UpdatePostMutationVariables = Exact<{
  updatePostText: Scalars['String'];
  updatePostId: Scalars['Float'];
  updatePostTitle: Scalars['String'];
}>;


export type UpdatePostMutation = { __typename?: 'Mutation', updatePost?: Maybe<{ __typename?: 'Post', id: number, updatedAt: string, createdAt: string, title: string, creatorId: number, text: string, creator: { __typename?: 'User', username: string, id: number } }> };
...
export type GetCommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', id: number, createdAt: string, creatorId: number, postId: number, text: string, creator: { __typename?: 'User', username: string, id: number, email: string } }> };
...
export type PostQuery = { __typename?: 'Query', post?: Maybe<{ __typename?: 'Post', id: number, creatorId: number, text: string, title: string, creator: { __typename?: 'User', id: number, username: string, email: string } }> };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, createdAt: string, title: string, textSnippet: string, creator: { __typename?: 'User', createdAt: string, email: string, id: number, username: string } }> } };
...
export const UpdatePostDocument = gql`
    mutation UpdatePost($updatePostText: String!, $updatePostId: Float!, $updatePostTitle: String!) {
  updatePost(text: $updatePostText, id: $updatePostId, title: $updatePostTitle) {
    id
    updatedAt
    createdAt
    title
 ...
 *   variables: {
 *      updatePostText: // value for 'updatePostText'
 *      updatePostId: // value for 'updatePostId'
 *      updatePostTitle: // value for 'updatePostTitle'
 *   },
 * });
 */
 ...
 *   variables: {
 *      commentsPostId: // value for 'commentsPostId'
 *   },
 * });
 */
